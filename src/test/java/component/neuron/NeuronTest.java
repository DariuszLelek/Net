...
//        neuron.getConnectionWeight(firstInputConnection).getConnection().setNumericValue(connectionValue1);
//        neuron.getConnectionWeight(secondInputConnection).getWeight().set(weight2);
//        neuron.getConnectionWeight(secondInputConnection).getConnection().setNumericValue(connectionValue2);
//
//        neuron.fire();
//
